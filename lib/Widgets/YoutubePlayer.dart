...
class _YoutubePlayerState extends State<YoutubePlayer> {
  ...
  late YT.PlayerState _playerState;
  late YT.YoutubeMetaData _videoMetaData;
  double _volume = 100;
  bool _muted = false;
  ...
  void initState() {
    ...
    _videoMetaData = const YT.YoutubeMetaData();
    _playerState = YT.PlayerState.unknown;
  }
  ...
  Color _getStateColor(YT.PlayerState state) {
    switch (state) {
        ...
        onPressed: _isPlayerReady
            ? () {
                if (_idController.text.isNotEmpty) {
                  var id = YT.YoutubePlayer.convertUrlToId(
                        _idController.text,
                      ) ??
                      '';
